 ...
 * Use the [ScheduleFragmentActivity.newInstance] factory method to
...
class ScheduleFragmentActivity : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ScheduleFragmentActivity.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ScheduleFragmentActivity().apply {
